...
class City : IsPartOfGameInfoSerialization, INamed {
    ...
    fun setTransients(civInfo: Civilization) {
        ...
        // 此标记不持久化；读档或回合副本必须从原占城提示恢复待处置状态。
        hasJustBeenConquered = civInfo.gameInfo.civilizations.any { player ->
            player.popupAlerts.any { it.type == com.unciv.logic.civilization.AlertType.CityConquered && it.value == id }
        }
